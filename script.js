...
class Factory {
  constructor(){
    ...
    this.massBuild = function(car, quantity){
...
// Write your code below:
let yellowmazda3 = new Car();
yellowmazda3.color = "yellow";
yellowmazda3.trim = "Touring";
yellowmazda3.model = "Mazda3"
let yellowmazda3_options = ["weather package", " satellite radio", " rear spoiler"];

yellowmazda3.customerBuild(yellowmazda3, yellowmazda3_options);
...
// Write your code below:
miataRf.massBuild(miataRf, 15000);
...
console.log(miataRf);
miataRf.color = "Black"
var miataRf_options = ["hid headlights", " sports suspension", " leather steering wheel", " heated seats", " adaptive cruise control"];

miataRf.customerBuild(miataRf, miataRf_options);
...
trailBlazer.massBuild(trailBlazer, 35000);
...
// Write your code below:
trailBlazer.color = "Red";
let trailBlazer_options = ["seat warmers", " tinted windows", " fog lamps"];
trailBlazer.customerBuild(trailBlazer, trailBlazer_options);
